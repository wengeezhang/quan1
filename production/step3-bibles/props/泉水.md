...
| **视觉状态变化** | 是（默认期——无可见状态变化） |
| **是否需要阶段注册表** | 是（默认期——无可见状态变化） |
...
|----------|---------|---------|------------|
| 默认期 | 始终保持统一外观，无可见状态变化 | ch1-ch71 | 无可见变化 |
