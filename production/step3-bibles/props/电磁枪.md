...
|----------|---------|---------|------------|
| 默认期 | 始终保持统一外观，无可见状态变化 | ch35-ch71 | 无可见变化 |
...
### 场景1：默认期-道具展示 - 军事装备库 | Scene 1: Concept Art - Military Armory Display
...
### 场景2：默认期-战斗应用 - 城镇进攻 | Scene 2: Combat Application - Coastal Town Assault
...
### 场景3：默认期-目标命中效果 | Scene 3: Impact and Aftermath
