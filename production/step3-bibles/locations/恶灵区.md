...
| stage_id | 阶段名 | 时间周期 | 环境状态 | 灵魂群落状态 | 核心冲突 |
|----------|--------|--------|--------|-----------|---------|
| **S01_default** | 默认期（秩序阶段） | 第3~20章 | 十八层塔完整，灵能栅栏启动，明确的等级划分 | 数百万恶灵被分层封禁，集体压抑感，遵循塔层等级秩序 | 主角初次接触/观察系统运作 |
| **S02_awakening** | 唤醒期（动荡阶段） | 第21~50章 | 塔层开始崩解征兆，下层恶灵骚动，灵能屏障频繁波动 | 群体意识苏醒，下层恶灵聚集能量，集体叛逆倾向增强 | 秩序破裂/阴间权力争夺 |
| **S03_climax** | 决战期（崩溃阶段） | 第51~65章 | 十八层塔全面瓦解，灵能屏障失效，空间物理规则混乱 | 恶灵全面解禁，数百万个体融合或分裂，灵魂光团聚变爆发 | 终极对峙/救赎vs毁灭 |
| **S04_aftermath** | 战后期（重建阶段） | 第66~71章 | 空间重构中，残留能量涌动，新的秩序框架浮现 | 幸存者聚集、新的层级关系建立或消亡 | 结局定型/新世界诞生 |
