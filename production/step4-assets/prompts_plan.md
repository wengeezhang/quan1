...
#### 6. 提示词5：默认期-泉水治疗汤药场景（老吴准备汤药） [默认期]
...
#### 4. 提示词4：默认期-数据显示细节 - 元神计数与倒计时面板 [默认期]
