...
- `production/step2-visual-design/art_direction.md`——全局视觉风格定义（第七章：全局 Style Prompt 前缀）

**研究方法**：
1. 先读 `production/step2-visual-design/art_direction.md` 第七章，提取全局 style prompt 前缀
